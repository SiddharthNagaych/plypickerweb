  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/auth/request-otp", {
        ...
        body: JSON.stringify({ phone: formData.mobileNumber }),
      });
...
const handleOTPVerify = async (otp: string) => {
  ...
  try {
    ...
    // Only proceed if OTP verification succeeded
    const saveResponse = await fetch("/api/auth/save-user-data", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
const handleGoogleSignUp = async () => {
  try {
    ...
    await signIn("google", {
      callbackUrl: window.location.href, // Use current URL as callback
    });
  } catch (error) {
        ...
        <div className="flex flex-col flex-1 overflow-y-auto md:overflow-hidden">
          ...
          <div className="flex flex-col flex-1 pt-16 px-4 pb-3 md:pt-7 md:px-7 md:pb-3">
            ...
            <div className="flex justify-center mb-4 md:mb-0">
              <div
                className="bg-gray-100 rounded-lg shadow-sm flex flex-col w-full max-w-[350px] p-4
                           h-auto md:h-[531px]"
                style={{
                  borderRadius: "8px",
                }}
                ...
                {currentStep === "signup" ? (
                  <>
                    ...
                    <div className="space-y-2 flex-1">
                      ...
                      {/* Email and Pincode Row - Stack on mobile */}
                      ...
                      {/* Mobile Number and Gender Row - Stack on mobile */}
                      <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3">
                        <div>
                          <label className="block text-sm font-semibold text-gray-700">
                            Mobile Number
          ...
          {/* Image Strip - Responsive and scrollable */}
